...
interface LogoItem {
  ...
  href?: string;
  ariaLabel?: string;
  node?: ReactNode; // For passing custom components like react-icons
}
...
export const LogoLoop = memo(({
  ...
  useResizeObserver(
    updateDimensions,
    [containerRef as React.RefObject<HTMLElement>, seqRef as React.RefObject<HTMLElement>],
  ...
  useAnimationLoop(
    trackRef as React.RefObject<HTMLElement>,
    targetVelocity,
    seqWidth,
    seqHeight,
    isHovered,
